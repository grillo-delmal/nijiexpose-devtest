...
You can get the latest builds from the [release section](https://github.com/grillo-delmal/nijiexpose-nightly/releases/tag/nightly).
...
Download [WinDbg](http://www.windbg.org/) and the source code from the [release section](https://github.com/grillo-delmal/nijiexpose-nightly/releases/tag/nightly)... you can figure out the rest from there.
